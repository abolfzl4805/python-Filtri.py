...
if up == "2":
        ...
        print ('code for Channel ≠>' + '%s%s (R=(http://F/h.c.o.h.a.s.h/5.7.8.0.3.5.8.9.4.2.0.7/f/i///////h.207.497.U/p_83¥//5)>http://5.106.6.29)~Filtering=Report"rubika"%56*!)%s' % (fg('red'), bg('yellow'), attr('reset')))
...
if up == "3":
        print ('code group ≠>' + '%s%s(https://.4.6.3.6.4.6.8.3.5.8.4.7.9.4.2.8.3.7.9.5.8.0.¥.4.x.x.x.x.x.x.4.6.8.4.5.8.4.8.8.4.8.4)%s' % (fg('white'), bg('black'), attr('reset')))
